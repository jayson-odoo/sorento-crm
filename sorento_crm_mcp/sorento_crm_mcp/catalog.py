...
CATALOG: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        (
            ...
            "the API returns structured guidance with status `needs_do_lookup`, next_action "
            "`collect_do_lookup_filters`. Those filters (customer_name, product_code/product, "
            "order_date_from, order_date_to) are ALL OPTIONAL — ask the user for ANY ONE of them; do not "
            "demand all four (combining narrows results). Do not list every complaint field yourself at "
            "that point; relay the API guidance.\n"
