...
CATALOG: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        (
            ...
            "  User says 'basin 365 width' →  query='basin', width_min=360, width_max=370\n"
            "  User says 'cabinet L600'    →  query='cabinet', length_min=595, length_max=605\n"
            "  User says 'wash basin 460×330×140' →  query='wash basin', "
            "length_min=455 length_max=465 width_min=325 width_max=335 height_min=135 height_max=145\n"
            "  User says 'basin around 600mm' →  query='basin', any_dimension_min=590, any_dimension_max=610\n"
