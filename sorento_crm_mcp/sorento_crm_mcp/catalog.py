...
CATALOG: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        (
            ...
            "`collect_do_lookup_filters`, and asks ONLY for customer_name, product_code/product, and "
            "order_date_from/order_date_to. Do not list every complaint field yourself at that point; "
            "relay the API guidance.\n"
            "After the user provides customer + product + date range, use order-management tools "
