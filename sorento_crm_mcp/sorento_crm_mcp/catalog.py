...
CATALOG: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        (
            ...
            "once it ends, so there is nothing to explain away. Pass active=false when the user explicitly "
            "asks for inactive / expired / historical promotions. period_from / period_to (YYYY-MM-DD) "
