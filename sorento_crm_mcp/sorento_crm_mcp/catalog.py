...
CATALOG: tuple[ToolSpec, ...] = (
    ...
    ToolSpec(
        ...
        (
            ...
            "  • They named NO kind (\"what documents do you have for me\") -> pass `contact_id` "
            "(+ `space_id`) and nothing else. A contact is a valid narrowing filter on its own and "
            "returns the handful of documents that contact may have - the dealer baseline plus their "
            "grants. This is the fallback, NOT a substitute for naming the class: a request for one "
            "named document answered this way lists everything and reads as though you ignored the "
            "question.\n"
            ...
            "Pass `contact_id` + `space_id` in ALL of these - see DOCUMENT TYPES below.\n"
