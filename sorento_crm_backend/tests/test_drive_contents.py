...
def db():
    with blank_session() as session:
        # Directory-tree walks use raw-SQL recursive CTEs on unqualified table
        # names, which schema_translate_map does not rewrite; align search_path
        # so they resolve to the blank schema rather than the real one.
