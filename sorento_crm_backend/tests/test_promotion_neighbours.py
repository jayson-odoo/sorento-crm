...
Uses the same in-memory sqlite fixture pattern the other promotion service tests
use (test_promotion_date_mode_filter.py) so it runs without the live Postgres DB.
"""
