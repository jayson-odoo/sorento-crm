...
class TestParserPromptAndContractsTeachSalesReport:
    ...
    def test_the_addendum_is_appended_to_the_single_body(self) -> None:
        ...
        # `STOCK_TASK_ADDENDUM` (PLAN-chatbot-dealer-stock-verdict.md S3, 22 Sep 2026)
        # stacked after this one, newest outermost, so it comes off first - the same
        # treatment this addendum itself gave `LOW_STOCK_ADDENDUM` when it landed.
