...
from app.services.scm.order_inquiry_reader import read_order_inquiry
...
def test_order_as_a_word_not_as_a_substring():
    ...
    from app.services.scm.order_inquiry_reader import _NOT_ORDERED
...
def test_columns_are_found_by_name_not_by_position():
    ...
    wrong on the other.
    """
    from app.services.scm.order_inquiry_reader import _header_map
