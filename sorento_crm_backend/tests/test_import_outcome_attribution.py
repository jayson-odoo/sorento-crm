...
# Mirrors the company the conftest scope default uses. A real enqueue always
# snapshots the active company onto the job; without it the worker runs
# system-scoped and owned inserts are refused outright (fail-closed).
SORENTO_COMPANY_ID = uuid.UUID("00000000-0000-0000-0000-000000000001")
