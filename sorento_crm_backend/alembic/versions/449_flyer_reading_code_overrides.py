...
landed ahead of it. `448_merge_s6b_ptag_heads.py` and
`s6b_reference_data_manage_perm.py` are vendored into this branch verbatim
(the `359_flyer_read_background_job` reasoning) so the graph resolves on a
branch-only checkout too.
