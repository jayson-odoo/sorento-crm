...
# The consumer intake surface (S3). Same /portal prefix and the same portal-token auth as
# the rest of the portal; kept in its own module because it belongs to the after-sales
# journey rather than to the generic form portal.
router.include_router(lodge.router, prefix="/portal", tags=["public-portal-lodge"])
