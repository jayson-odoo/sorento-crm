...
from app.api.v1.inventory import warehouses, stock, storage_zones, stock_batches, stock_ledger, stock_balance_snapshots
...
router.include_router(stock_balance_snapshots.router, prefix="/stock-balance-snapshots", tags=["stock-balance-snapshots"])