...
from app.api.v1.procurement import suppliers, product_suppliers, packing_lists, grn, spo_allocations, picking_lines, stock_inquiries, purchase_requests, request_quotations
...
router.include_router(request_quotations.router, prefix="/request-quotations", tags=["request-quotations"])
