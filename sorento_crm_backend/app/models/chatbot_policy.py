...
class ChatbotDomain(Base):
    ...
    intents = Column(JSONB, nullable=False, server_default="[]")
    ...
    switch_words = Column(JSONB, nullable=False, server_default="[]")
    ...
    ladder = Column(JSONB, nullable=False, server_default="[]")
