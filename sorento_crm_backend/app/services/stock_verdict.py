...
24 Sep 2026) for chatbot-stock-ask-v2 S3 parity. `stock_ask_branch.py` (a LATER step of
this same slice) replaces this module's verdict/threshold logic with the four B1-B4
branches (R6); this file exists only so `_apply_stock_visibility`'s ported availability
branch reaches the SAME shape #1118 shipped before that replacement happens.
