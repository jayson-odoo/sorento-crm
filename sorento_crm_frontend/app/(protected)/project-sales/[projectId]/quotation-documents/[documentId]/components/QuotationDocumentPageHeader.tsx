 ...
 * UI), and the trail below it ends on that same number because PageHeader takes
 * its last crumb from the title.
 *
...
export function QuotationDocumentPageHeader({
  ...
  return <PageHeader title={document.data?.document_no ?? 'Quotation Document'} />;
}
