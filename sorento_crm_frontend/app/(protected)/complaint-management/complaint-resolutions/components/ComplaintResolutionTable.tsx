...
interface Props {
  rows: ComplaintResolution[];
  searchQuery?: string;
  onEdit?: (row: ComplaintResolution) => void;
  onDelete?: (row: ComplaintResolution) => void;
}

export default function ComplaintResolutionTable({
  rows,
  searchQuery = '',
  onEdit,
  onDelete,
  ...
  if (filtered.length === 0) {
    return (
      <div className="text-sm text-muted-foreground py-4">No resolutions found</div>
    );
  }
