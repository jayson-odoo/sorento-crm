...
const badgeButtonVariants = cva(
  'cursor-pointer transition-opacity duration-(--duration-fast) ease-(--ease-standard) inline-flex items-center justify-center leading-none size-3.5 [&>svg]:opacity-100! [&>svg]:size-3.5! p-0 rounded-md -me-0.5 opacity-60 hover:opacity-100',
  {
    variants: {
      variant: {
        default: '',
