...
const GRID_IN_FLOATING_SURFACE_SITES = new Map<string, string>([
  ...
  [
    'app/(protected)/project-sales/stock-debt/components/StockDebtCellDialog.tsx:602',
    'Demand tab, dialog rendered after the calendar grid closes. Already scrollerMaxHeight={false}. (Line moved 525 -> 602 when the dialog gained the R29 linked so_number/assigned_from cells and the `AssignedFromEntry` helper.)',
  ],
  [
    'app/(protected)/project-sales/stock-debt/components/StockDebtCellDialog.tsx:633',
    'Supply tab, same dialog. (Line moved 556 -> 633, same round.)',
  ],
  [
