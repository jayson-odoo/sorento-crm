...
export const dropdownMigrationAllowlist = [
  ...
  'app/(protected)/user-management/access-agents/components/AccessAgentForm.test.tsx',
  'app/(protected)/user-management/access-agents/components/AccessAgentForm.tsx',
  'app/(protected)/user-management/access-agents/components/AccessAgentFormModal.tsx',
  'app/(protected)/user-management/access-agents/components/McpToolBindingsEditor.tsx',
  'app/(protected)/user-management/access-agents/components/McpToolSelector.tsx',
