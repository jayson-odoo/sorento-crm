...
3. Click [**Reject**](/procurement-management/stock-inquiries#guide_target=procurement.stock-inquiries.reject-confirm-button) to confirm. The inquiry moves to **Rejected** and the rep is notified.

## Reopen a rejected inquiry

If an inquiry was rejected by mistake, click [**Reopen to pending project sales**](/procurement-management/stock-inquiries#guide_target=procurement.stock-inquiries.reopen-button) on the rejected record. The **Reopen stock inquiry** dialog asks for an optional reason; click [**Reopen**](/procurement-management/stock-inquiries#guide_target=procurement.stock-inquiries.reopen-confirm-button) to confirm.
