...
5. Choose how to finish:
   ...
   * **Update & Reply** — saves your response **and** sends it back to the requester via Respond.io. Use this when the reply is complete.
...
3. Click **Reject** to confirm. The inquiry moves to **Rejected** and the rejection reason is stored on the record and sent to the requester.

## Reopen a rejected inquiry

If a rejection was issued in error, click **Reopen to pending purchasing** (or **Reopen to pending project sales**, depending on which stage rejected it). The **Reopen stock inquiry** dialog asks for an optional reason; click **Reopen** to confirm.
