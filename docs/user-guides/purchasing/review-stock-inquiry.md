...
If a rejection was issued in error, click [**Reopen to pending purchasing**](/procurement-management/stock-inquiries#guide_target=procurement.stock-inquiries.reopen-button) (or [**Reopen to pending project sales**](/procurement-management/stock-inquiries#guide_target=procurement.stock-inquiries.reopen-button), depending on which stage rejected it). The **Reopen stock inquiry** dialog asks for an optional reason; click [**Reopen**](/procurement-management/stock-inquiries#guide_target=procurement.stock-inquiries.reopen-confirm-button) to confirm.
...
This panel is wired to the same Respond.io conversation that the requester uses on the portal, so messages flow both ways.
