...
6. (Optional) Adjust [**Access Levels**](/resource-management/attachment-directories#guide_target=resource-management.files.access-levels) (*End User*, *Dealer*, *Manager*) — these decide who can see the promotion through the portal.
