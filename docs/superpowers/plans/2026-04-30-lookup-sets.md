...
**Tech Stack:** FastAPI + SQLAlchemy + Alembic + Pydantic v2 (backend); Next.js 15 + TanStack Query + Tailwind + ReUI shell (frontend); pytest + vitest. Spec: `docs/superpowers/specs/2026-04-30-lookup-sets-design.md`.
