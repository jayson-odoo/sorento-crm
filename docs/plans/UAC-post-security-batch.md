...
UAC4.3 — **Given** `docs/user-guides/_shared/getting-started-for-new-users.md`, **then** it exists: zero-knowledge orientation (login, sidebar map, where data lives, how to ask the assistant), house-style.
