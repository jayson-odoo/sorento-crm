...
If the form is still in **Draft**, click **[Change to pending approval](#guide_target=procurement.approvals.change-to-pending-approval-button)** in the toolbar. Toast: *"Status set to Pending approval"*.

## Send for approval

When the form is in **Pending approval**, click **[Send for approval](#guide_target=procurement.approvals.send-for-approval-button)** in the toolbar.
