...
* `**[marketing/](./marketing/)**` - promotion upload, marketing-form upload, working a price tag request (design, pinned change requests, printing choice and collection, product-data review, design history).
...
* ✅ Marketing - drafted (Promotion, Marketing Form, Price Tag Requests: Design section + full-screen viewer, pinned change requests and Done, Printing / Mark ready for collection / Mark collected + auto-collect, Product data changed review, History).
