...
* `**[supply-chain/](./supply-chain/)**` - uploading the sales order book, purchase order book, Order Inquiry sheet and reorder-level listing that a reorder plan is built from; running a reorder plan and confirming decisions; printing the order summary sheet; deciding Buy vs Borrow on Fulfilment Planning; planning a sales order nobody decided (delivered or Completed included) and reading the Planned pill on the Sales Orders list; what happens when a sales order changes after planning (manual edit, book upload, or AutoCount) and how CS Confirms or Amends it.
