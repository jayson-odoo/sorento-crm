# Project Sales Rep - Submit a complaint, inquiry, request, sponsorship form, or price tag
...
* **A part the customer chooses from a list of two or more** arrives as an open row with its own select, placeholder *"Not sure, any of 4"*. Pick the code if you know it. If you don't, leave it open for marketing to fill in.
