...
Status: S1 to S6 DONE on `feat/scm-pool-chain-first` (R-N 3 Sep 2026, then AC-N.12's floor
ledger, then R-O). Engine, board proof and docs landed;
...
and AC-N.11 is two vitest cases in `supplyComposition.test.ts`. AC-N.12 (every pool's free
floor is one ledger, reported by the R-N coder) is
`tests/scm/test_project_supply_service_ladder.py::test_another_sites_pool_free_floor_is_spent_once_across_the_whole_walk`.
AC-N.10 (browser evidence on SO419417) is still owed.
