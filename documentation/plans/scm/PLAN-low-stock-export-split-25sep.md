...
Status: in progress, Phase 1 (25 Sep 2026). Owner ruled O1-O3 in the lavish round, 25 Sep. Track: feature (three-phase). Lane branch: `feat/low-stock-export-split`, worktree `sorento_crm-low-stock-split`.
