...
Status: **PR #356 OPEN, CI GREEN** 2026-08-28 (run 33103186103 on `1a67fb9cb`). Phases 1 to 3 done, review round (section 12) and CI round (section 15) fixed, live walk on SO414013 (section 11). Awaiting the captain's merge.
