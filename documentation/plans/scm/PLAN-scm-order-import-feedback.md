...
(branch `feat/scm-import-async`, stacked on that one). S5 built (branch
`feat/scm-po-spo-history`, stacked on S3 + S4; backend only, pytest green, no browser pass
needed - the channel has no new screen). S6 planned, captain's go pending. Contract:
