...
## Owner hand test fixes (round 3, 26 Sep)

Same method: the real components on an uncommitted scratch route under `next dev`, preinstalled
Chromium, a throwaway script. The picker is rendered on its own with four PO options, the first
carrying the description from the owner's screenshot, because the demo fixture has no PO lines.
No console errors; page horizontal overflow 0 at 1280 and at 375.

| File | Shows | Measured |
| --- | --- | --- |
| `s5-r3-w1-picker-1280.png`, `s5-r3-w1-picker-375.png` | W1: "Pick the product" open | Every option 32px tall, one line: "SRTWC8613-RL  One piece WC 700 x 380 x 730"; the full description is the row's title; typing "roughing" leaves only SRTWC8613-RL |
| `s5-r3-w2-segments-1280.png`, `s5-r3-w2-segments-375.png` | W2: both segmented controls, By date holding keyboard focus | Selected: primary fill, white text, weight 600; unselected: transparent, weight 500; the focus ring on By date is an offset ring, not a fill |
| `s5-r3-w3-queued-1280.png`, `s5-r3-w3-queued-375.png` | W3: a queued read | The PO read's card: "Waiting to be read", "7 pages", the bar, "This page updates itself" |
| `s5-r3-w3-running-1280.png`, `s5-r3-w3-running-375.png` | W3: 3 of 7 pages read | "Reading the document", "Page 4 of 7", bar `aria-valuenow` 43 |
